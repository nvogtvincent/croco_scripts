...
from coral_grid_methods_on_cmems import regrid_coral_raster as rcr
...
cmems_grid_file = data_dir + 'OSCAR_mask.nc'
...
##############################################################################
if S1_activate == 1:
    rcr(preproc_coral_file1, preproc_coral_file2, croco_grid_file, cmems_grid_file, data_dir)
else:
